...
import com.example.SW.Controller.mapper.DtoMapper;
...
public class RideController {
    ...
    public ResponseEntity<MessageResponse> rideStartHandler(@PathVariable Integer rideId,
            @RequestBody StartRideRequest req) throws UserException, RideException {
